...
import blogRoutes, { adminBlogRoutes } from "../modules/blog/blog.routes";
...
import usersRoutes, { adminCustomersRoutes } from "../modules/users/users.routes";
...
router.use("/options", publicOptionsRouter);
