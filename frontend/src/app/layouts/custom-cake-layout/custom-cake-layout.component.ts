...
@Component({
  ...
  template: `
    <div class="cc-layout">
      <header class="cc-header">
        <a class="cc-logo" routerLink="/" aria-label="WeBee Bakery">
          <img src="/assets/webee-logo.png" alt="" class="cc-logo__img" />
          <span class="cc-logo__text">WeBee</span>
        </a>
  ...
  styles: [`
    ...
    .cc-logo { display: inline-flex; align-items: center; gap: 8px; text-decoration: none; }
    .cc-logo__img { height: 40px; width: auto; }
    .cc-logo__text { font-family: t.$font-display; font-style: italic; font-weight: 550; color: t.$ink; font-size: 20px; }
    .cc-logo:hover .cc-logo__text { color: t.$primary; }
